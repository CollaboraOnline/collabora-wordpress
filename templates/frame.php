...
<?php // phpcs:disable WordPress.WP.EnqueuedResources.NonEnqueuedStylesheet ?>
	<link rel="stylesheet" id="collabora-wordpress-cool-css" href="<?php echo esc_url( $args['base_url'] ); ?>/assets/css/cool.css" media="all">
	<script id="collabora-wordpress-cool-js" src="<?php echo esc_url( $args['base_url'] ); ?>/assets/js/cool.js"></script>
